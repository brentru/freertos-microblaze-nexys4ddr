...
ISEStep( "vivado",
         "-log microblaze_impl_axi_ethernetlite_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microblaze_impl_axi_ethernetlite_0_0.tcl" );
