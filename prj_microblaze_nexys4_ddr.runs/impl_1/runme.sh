...
HD_PWD='C:/Users/brent/prj_microblaze_nexys4_ddr/prj_microblaze_nexys4_ddr.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log microblaze_impl_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source microblaze_impl_wrapper.tcl -notrace
