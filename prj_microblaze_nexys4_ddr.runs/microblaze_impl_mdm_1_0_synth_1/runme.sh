...
HD_PWD='C:/Users/brent/prj_microblaze_nexys4_ddr/prj_microblaze_nexys4_ddr.runs/microblaze_impl_mdm_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microblaze_impl_mdm_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microblaze_impl_mdm_1_0.tcl
