...
HD_PWD='C:/Users/brent/prj_microblaze_nexys4_ddr/prj_microblaze_nexys4_ddr.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microblaze_impl_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microblaze_impl_wrapper.tcl
